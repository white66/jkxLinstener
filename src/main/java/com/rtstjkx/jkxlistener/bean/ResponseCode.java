package com.rtstjkx.jkxlistener.bean;
...
public class ResponseCode {
     ...
     * @return 响应对象
     */
    public ResponseCode success(String msg) {
     ...
     * @return 响应对象
     */
    public ResponseCode success(Object data) {
     ...
     * @return 响应对象
     */
    public ResponseCode success(String msg, Object data) {
        this.meta = new Meta(DEAFAULT_SUCCESS_CODE, msg);
        this.data = data;
        return this;
    }
     ...
     * @return 响应对象
     */
    public ResponseCode success(HttpStatus httpStatus, String msg, Object data) {
     ...
     * @return 响应对象
     */
    public ResponseCode failure(String msg) {
     ...
     * @return 响应对象
     */
    public ResponseCode failure(Object data) {
     ...
     * @return 响应对象
     */
    public ResponseCode failure(String msg, Object data) {
        this.meta = new Meta(DEAFAULT_FAILURE_CODE, msg);
        this.data = data;
        return this;
    }
     ...
     * @return 响应对象
     */
    public ResponseCode failure(HttpStatus httpStatus, String msg, Object data) {
        this.meta = new Meta(httpStatus.value(), msg);
        this.data = data;
        return this;
    }
